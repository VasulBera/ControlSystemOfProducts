...
FileInputStream local = null;
        ...
        try {
            in = new FileInputStream("http:\\localhost:8811\\job\\jobExporter\\ws\\service\\src\\main\\resources\\database.properties");
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        ...
        try {
            out = new FileOutputStream("http:\\localhost:8811\\job\\jobExporter\\ws\\service\\src\\main\\resources\\database.properties");
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
