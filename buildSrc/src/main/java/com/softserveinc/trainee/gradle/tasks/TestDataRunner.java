...
/**
 * Created by vberv on 7/11/2016.
 */
public class TestDataRunner extends DefaultTask{
    private static final String PATH_TO_TEST_DATA = "service/src/main/resources/TestData";
    ...
    public void runSqlFiels(){
        ...
        try(Connection connection = DriverManager.getConnection(MS_SQL_SERVER_ADDRES + "user=" + username + ";password=" + password)){
            ...
            File mainDirectory = new File(PATH_TO_TEST_DATA);
